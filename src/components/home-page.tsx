...
import { HeroModelLabel } from "./hero-model-label";
import { OfferCountdown } from "./offer-countdown";
import { ComparisonVideo } from "./comparison-video";
...
function resolveCheckoutHref(url: string) {
  return url.trim() || "#choose-model";
}
